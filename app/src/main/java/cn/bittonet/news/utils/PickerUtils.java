...
import cn.bittonet.news.view.FloatPicker;
...
public class PickerUtils {
    ...
    public static void showDatePicker(Activity activity, String title, String startDate,
            String endDate, final DatePicker.OnYearMonthDayPickListener listener) {
        showDatePicker(activity, title, startDate, endDate, null, listener);
    }
     ...
     * @param listener    事件
     */
    public static void showDatePicker(Activity activity, String title, String currentDate,
            final DatePicker.OnYearMonthDayPickListener listener) {
        showDatePicker(activity, title, null, null, currentDate, listener);
    }
    ...
    public static void showDatePicker(Activity activity, String title, String startDate,
        ...
        if (StringUtils.isEmpty(startDate)) {
            ...
            start_y = Integer.valueOf(
                    TimeUtils.formatDate(startDate, TimeUtils.Y_FORMAT));
            start_m = Integer.valueOf(
                    TimeUtils.formatDate(startDate, TimeUtils.M_FORMAT));
            start_d = Integer.valueOf(
                    TimeUtils.formatDate(startDate, TimeUtils.D_FORMAT));
        }
        datePicker.setRangeStart(start_y, start_m, start_d);
        if (StringUtils.isNotEmpty(endDate)) {
            int end_y, end_m, end_d;
            end_y = Integer.valueOf(
                    TimeUtils.formatDate(endDate, TimeUtils.Y_FORMAT));
            end_m = Integer.valueOf(
                    TimeUtils.formatDate(endDate, TimeUtils.M_FORMAT));
            end_d = Integer.valueOf(
                    TimeUtils.formatDate(endDate, TimeUtils.D_FORMAT));
        ...
        if (StringUtils.isEmpty(currentDate)) {
            ...
            y = Integer.valueOf(
                    TimeUtils.formatDate(currentDate, TimeUtils.Y_FORMAT));
            m = Integer.valueOf(
                    TimeUtils.formatDate(currentDate, TimeUtils.M_FORMAT));
            d = Integer.valueOf(
                    TimeUtils.formatDate(currentDate, TimeUtils.D_FORMAT));
        }
        datePicker.setSelectedItem(y, m, d);
        datePicker.setResetWhileWheel(false);
        datePicker.setOnDatePickListener(
                (DatePicker.OnYearMonthDayPickListener) (year, month, day) -> {
                    if (listener != null) {
    ...
    public static void showDoublePicker(Activity activity, String title,
        ...
        picker.setPressedTextColor(ContextCompat.getColor(activity, PRESSED_TEXT_COLOR));
        picker.setSubmitTextColor(ContextCompat.getColor(activity, SUBMIT_TEXT_COLOR));
        picker.setOnPickListener((selectedFirstIndex, selectedSecondIndex) -> {
            if (null != listener) {
    ...
    public static void showFloatPicker(Activity activity, String title, String unit,
        ...
        picker.setPressedTextColor(ContextCompat.getColor(activity, PRESSED_TEXT_COLOR));
        picker.setSubmitTextColor(ContextCompat.getColor(activity, SUBMIT_TEXT_COLOR));
        picker.setOnPickListener(value -> {
            if (null != listener) {
    ...
    public static void showLinkagePicker(Activity activity, String title,
            ArrayList<String> firstList, ArrayList<ArrayList<String>> secondList,
