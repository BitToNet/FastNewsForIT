...
import com.chingsoft.museum.bean.RepoAreaBean;
import com.chingsoft.museum.bean.SaveStandardBean;
...
public interface ApiService {
    ...
    Observable<BaseBean<List<DataBean>>> getHistoryData(@Query("token") String token,
            @Query("endTime") long endTime, @Query("id") int id,
            @Query("startTime") long startTime, @Query("monitorType") String monitorType,
            @Query("sessionId") String sessionId);
